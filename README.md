...
| debug_decoder_output | Enables serial output of the RGB data detected by the decoder |

I prefer the PlatformIO CLI, so I use the below command for uploading the firmware:
